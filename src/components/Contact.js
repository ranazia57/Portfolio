    ...
    <section className="min-h-screen bg-black text-white py-16 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <form
          ref={form}
          onSubmit={sendEmail}
          className="grid grid-cols-1 gap-6 text-left animate-fade-up duration-700"
        >
          <input
            type="text"
            name="user_name"
            ...
            required
            className="w-full p-4 bg-black border-2 border-green-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all"
          />
          <input
            type="email"
            name="user_email"
          ...
          <textarea
            ...
            required
            className="w-full p-4 bg-black border-2 border-green-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all resize-none"
          ></textarea>
...
>
  ...
  ></span>
  <span className="relative text-base font-semibold flex">send messege <FaArrowRight className='ml-2 mt-1.5'/></span>
</button>
